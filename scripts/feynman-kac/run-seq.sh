#!/usr/bin/env bash
#
# run-seq.sh — Build and run the Feynman-Kac sequential (baseline) benchmark inside Docker
#
# Usage:
...
echo "============================================"
echo " Feynman-Kac Sequential (Baseline) Runner"
echo "============================================"
...
echo ""
echo "============================================"
echo " Running Feynman-Kac sequential baseline"
echo "============================================"
echo ""
