#!/usr/bin/env bash
#
# run-seq.sh — Build and run the Moldyn sequential (baseline) benchmark inside Docker
#
# Usage:
#   ./scripts/moldyn/run-seq.sh [particles]
...
echo "============================================"
echo " Moldyn Sequential (Baseline) Runner"
echo "============================================"
...
DOCKER_SCRIPT+="
echo \" Running Moldyn sequential: particles=$PARTICLES\"
echo \"============================================\"
echo \"\"
