#!/usr/bin/env bash
#
# run-omp-reference.sh — Build and run Moldyn OpenMP reference inside Docker
#
# Usage:
#   ./scripts/moldyn/run-omp-reference.sh [particles] [threads]
#   ./scripts/moldyn/run-omp-reference.sh 20 10
#
# Requirements:
...
SRC_FILE="$REPO_ROOT/problems/moldyn/reference/omp/moldyn.c"
